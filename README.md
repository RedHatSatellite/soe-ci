...
<<<<<<< HEAD
* Register the server to Satellite 6 RHEL7 base and common repos. You need the RHEL 7 Common repos for puppet.
...
* Configure `mock` by copying the [rhel-7-x86_64.cfg] and/or [rhel-6-x86_64.cfg] file to `/etc/mock` on the jenkins server, and linking ensuring that the link `/etc/mock/default.cfg` point to it.
